  ...
  data: function () {
      return {
          columnsTemplate: [
              ...
              { title:'Ca', field: 'ca', visible: false },
              ...
              { title:'Urine Glucose (Dipstick)', field: 'urine_glucose_dipstick', visible: false },
              { title:'Urine Glucose', field: 'urine_glucose', visible: false },
              { title:'Urine Prot (Dipstick)', field: 'urine_prot_dipstick', visible: false },
