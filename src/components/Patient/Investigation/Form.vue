    ...
    >
        ...
        <div class="card-content">
            ...
            <div class="content">
                ...
                <div class="columns">
                    <div class="column field-trigger-link">
                        <a
                            class="is-pulled-right allfield-link is-size-7"
                            @click="triggerLabFields"
                        >
                            {{ showAllField ? "Click here to hide the below fields..." : "Click here to add other lab results..." }}
                        </a>
                        
                        <hr v-if="showAllField" />
                    </div>
                </div>
